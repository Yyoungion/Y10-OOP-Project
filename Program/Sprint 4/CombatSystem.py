...
class Hero(Character):
    def __init__(self,name):
        ...
        self.give(Weapon("Stick",0,random.randrange(5,15)))
        self.give(ManaHealing("Lvl 1 Mana Potion",5,10))
        self.give(Healing("Lvl 1 Health Potion",5,10))
        self.give(Gold(1000000))
        self.give_and_equip(Armour("Diamond chestplate",25,20 ,'Torso'))
        self.give_and_equip(Armour("Diamond helmet",22,15 ,'Head'))
        self.give_and_equip(Armour("Diamond leggings",24,15,'Legs'))
        self.give_and_equip(Weapon("Lvl 3 Diamond Sword",29, 45))
...
def CultistFinalBoss():
    ...
    Player.give(Item("Strange Artifact",0))
